...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void freeOptionalAttendeesAreConsidered() {
    // Have each person have different consecutive meetings with free
    // two common free times. Options should include all free times where
    // both optional and mandatory attendees can attend.
    //
    // Events  :       |--A--||-C-||--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
